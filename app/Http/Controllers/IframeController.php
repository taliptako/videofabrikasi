...
class IframeController extends Controller
{
    public function show($id, $hash)
    {
        ...
        $video->dash_url = "https://". $video->user->id .".b-cdn.net/". $video->id . "/" . $video->extension . "/dash.mpd";
        $video->fallback_url = "https://". $video->user->id .".b-cdn.net/". $video->id . "/" . "/mp4/fallback_480p.mp4";
