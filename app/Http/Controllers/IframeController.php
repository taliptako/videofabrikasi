...
class IframeController extends Controller
{
    public function show($id, $hash)
    {
        ...
        $video->dash_url = 'https://1540476022.rsc.cdn77.org/'.$video->id.'/'.$video->extension.'/dash.mpd';
        $video->fallback_url = 'https://1540476022.rsc.cdn77.org/'.$video->id.'/mp4/fallback_480p.mp4';
